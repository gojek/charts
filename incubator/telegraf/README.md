...
*This chart is another maintained version of telegraf helm chart from [kubernetes/charts](https://github.com/kubernetes/charts/tree/master/stable/telegraf)*
...
helm install gojektech-incubator/telegraf
```
...
```console
$ helm install --name my-release gojektech-incubator/telegraf
```
...
```console
## to just use telegraf-ds
$ helm install --name my-release --set single.enabled=false gojektech-incubator/telegraf

## to just use telegraf-s
$ helm install --name my-release --set daemonset.enabled=false gojektech-incubator/telegraf
```
...
```console
$ helm install --name my-release -f values.yaml gojektech-incubator/telegraf
```
